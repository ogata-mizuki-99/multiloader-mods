 ...
 */
public final class EconomyConfigScreen extends Screen {
    private final ModContainer container;
    private final Screen parent;

    public EconomyConfigScreen(ModContainer container, Screen parent) {
    ...
    private void pushToServer() {
        ...
        EconomyPlatform.sendToServer(EconomyCommonConfigPushPayload.fromLocalConfig());
        mc.player.sendSystemMessage(
