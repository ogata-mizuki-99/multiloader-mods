    ...
    public static void render(GuiGraphicsExtractor guiGraphics, DeltaTracker deltaTracker) {
        ...
        if (!loggedRender) {
            EconomyMod.LOGGER.info(
                    "EconomyHudOverlay.render() called successfully at least once! Current balance: {}, Bank balance: {}",
        ...
        String balanceText = EconomyMasterI18n.tr(
                "economy.hud.balance",
                EconomyMasterI18n.formatCurrency(EconomyMod.getCurrentBalance()),
                EconomyMasterI18n.formatCurrency(EconomyMod.getCurrentBankBalance())).getString();
