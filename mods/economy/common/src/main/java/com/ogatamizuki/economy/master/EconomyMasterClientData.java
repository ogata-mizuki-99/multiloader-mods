...
public final class EconomyMasterClientData {
    ...
    public static String fetchShopItemsJson() {
        try (InputStream in = EconomyCommon.class.getResourceAsStream("/data/economy/master/economy_master.json")) {
            ...
            EconomyCommon.LOGGER.error("Failed to read bundled shop items on client", e);
            return null;
        }
    }
    ...
    public static String fetchEtfItemsJson() {
        try (InputStream in = EconomyCommon.class.getResourceAsStream("/data/economy/master/economy_master.json")) {
            ...
            EconomyCommon.LOGGER.error("Failed to read bundled etf items on client", e);
            return null;
        }
    }
    ...
    public static String fetchConfigJson() {
        try (InputStream in = EconomyCommon.class.getResourceAsStream("/data/economy/master/economy_master.json")) {
            ...
            EconomyCommon.LOGGER.error("Failed to read bundled master config on client", e);
            return null;
        }
    }
    ...
    private static String fetchSection(String section, boolean rewards, boolean shops, boolean shopItems, boolean etfItems) {
        try (InputStream in = EconomyCommon.class.getResourceAsStream("/data/economy/master/economy_master.json")) {
            ...
            EconomyCommon.LOGGER.error("Failed to read bundled master on client", e);
            return null;
        }
    }
