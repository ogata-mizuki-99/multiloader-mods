...
public class EconomyAdminScreen extends Screen {
            ...
            Minecraft.getInstance().execute(() -> {
                ...
                if (json != null && !"null".equals(json)) {
                    try {
                        ...
                        EconomyCommon.LOGGER.error("Failed to parse player balances", e);
            ...
            Minecraft.getInstance().execute(() -> {
                ...
                if (resolvedJson != null && !"null".equals(resolvedJson)) {
                    try {
                        ...
                        EconomyCommon.LOGGER.error("Failed to parse master config", e);
            ...
            Minecraft.getInstance().execute(() -> {
                ...
                if (resolvedJson != null && !"null".equals(resolvedJson)) {
                    try {
                        ...
                        EconomyCommon.LOGGER.error("Failed to parse master list", e);
            ...
            Minecraft.getInstance().execute(() -> {
                ...
                if (resolvedJson != null && !"null".equals(resolvedJson)) {
                    try {
                        ...
                        EconomyCommon.LOGGER.error("Failed to parse shop list", e);
            ...
            Minecraft.getInstance().execute(() -> {
                ...
                if (resolvedJson != null && !"null".equals(resolvedJson)) {
                    try {
                        ...
                        EconomyCommon.LOGGER.error("Failed to parse shops for assignment", e);
                    }
                }
                requestMasterList();
            });
    ...
    private void sendReset() {
        ...
        refreshAdminWidgets();
        EconomyPlatform.sendToServer(new EconomyAdminActionPayload(
                "RESET",
                resetBalances,
                resetRankingMetrics,
                resetPortfolios,
    ...
    private void sendCompileRanking() {
        ...
        refreshAdminWidgets();
        EconomyPlatform.sendToServer(adminAction("COMPILE_RANKING", 0));
    }
    ...
    private void sendGiveSpawnEgg(int shopId) {
        ...
        refreshAdminWidgets();
        EconomyPlatform.sendToServer(adminAction("GIVE_SPAWN_EGG", shopId));
    }
    ...
    private void sendGiveAllSpawnEggs() {
        ...
        refreshAdminWidgets();
        EconomyPlatform.sendToServer(adminAction("GIVE_ALL_SPAWN_EGGS", 0));
    }
    ...
    private void sendSaveMasterConfig() {
        ...
        refreshAdminWidgets();
        EconomyPlatform.sendToServer(new EconomyMasterConfigPayload(
                "SAVE",
                deathPenalty,
                shortSell,
                etfInterval,
    ...
    private void sendSaveMasterRewards() {
        ...
        refreshAdminWidgets();
        EconomyPlatform.sendToServer(new EconomyMasterEditPayload("SAVE_REWARDS", edits.toString()));
    }
    ...
    private void sendSaveMasterItems() {
        ...
        refreshAdminWidgets();
        EconomyPlatform.sendToServer(new EconomyMasterEditPayload("SAVE_ITEMS", edits.toString()));
    }
    ...
    private void sendSaveMasterShopItems() {
        ...
        refreshAdminWidgets();
        EconomyPlatform.sendToServer(new EconomyMasterEditPayload("SAVE_SHOP_ITEMS", edits.toString()));
    }
    ...
    private void sendSaveMasterEtfItems() {
        ...
        refreshAdminWidgets();
        EconomyPlatform.sendToServer(new EconomyMasterEditPayload("SAVE_ETF_ITEMS", edits.toString()));
    }
