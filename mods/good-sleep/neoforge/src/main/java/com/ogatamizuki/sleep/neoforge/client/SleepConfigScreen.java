package com.ogatamizuki.sleep.neoforge.client;
...
public final class SleepConfigScreen extends Screen {
    ...
    public SleepConfigScreen(ModContainer container, Screen parent) {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(Button.builder(
                Component.translatable("good_sleep.configuration.open_editor"),
    ...
    private void pushToServer() {
        ...
        if (mc.getConnection() == null) {
            mc.player.sendSystemMessage(
                    Component.translatable("good_sleep.configuration.push_need_connection")
                            .withStyle(ChatFormatting.RED));
            return;
        }
        mc.getConnection().send(SleepCommonConfigPushPayload.fromLocalConfig());
        mc.player.sendSystemMessage(
                Component.translatable("good_sleep.configuration.push_sent").withStyle(ChatFormatting.YELLOW));
    }
    ...
    public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        guiGraphics.centeredText(
                this.font,
                Component.translatable("good_sleep.configuration.push_hint"),
                this.width / 2,
                this.height / 2 - 40,
                0xFFAAAAAA);
