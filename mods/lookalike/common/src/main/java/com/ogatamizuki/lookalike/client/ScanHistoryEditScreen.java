...
public class ScanHistoryEditScreen extends Screen {
    ...
    public static void open() {
        ...
        LookalikeClientState.onScanScreenOpened();
        ScanHistoryEditScreen screen = new ScanHistoryEditScreen();
        screen.entries = new ArrayList<>(LookalikeClientState.getScanHistory());
        mc.setScreen(screen);
    }
    ...
    private void delete(ScanEntry entry) {
        LookalikeCommon.sendToServer.accept(ScanHistoryActionPayload.delete(entry.uuid().toString()));
    }
    ...
    public void onClose() {
        super.onClose();
        LookalikeClientState.onScanScreenClosed();
    }
