...
public class ClientSelectionRegistry {
    ...
    public static boolean isHoldingMarker(Minecraft mc) {
        ...
        return mc.player.getMainHandItem().is(InstantStructureCommon.STRUCTURE_MARKER.get())
                || mc.player.getOffhandItem().is(InstantStructureCommon.STRUCTURE_MARKER.get());
    }
