...
public final class BuilderGuiPreferences {
    ...
    public static void ensureLoaded() {
        ...
        try (Reader reader = Files.newBufferedReader(FILE)) {
            ...
            InstantStructureCommon.LOGGER.warn("Failed to load builder GUI preferences", e);
        }
    }
    ...
    public static void saveSelection(String category, String templateName) {
        ...
        try {
            ...
            InstantStructureCommon.LOGGER.warn("Failed to save builder GUI preferences", e);
        }
    }
