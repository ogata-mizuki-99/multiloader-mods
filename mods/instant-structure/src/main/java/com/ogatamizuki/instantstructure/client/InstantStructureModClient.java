...
@Mod(value = InstantStructureMod.MODID, dist = Dist.CLIENT)
public class InstantStructureModClient {

    public InstantStructureModClient(ModContainer container) {
        IEventBus modEventBus = container.getEventBus();
        modEventBus.addListener(this::registerClientPayloads);
        modEventBus.addListener(InstantStructureModClient::onRegisterGuiLayers);
    ...
    private static void onRegisterGuiLayers(RegisterGuiLayersEvent event) {
        event.registerAbove(
                ...
                Identifier.fromNamespaceAndPath(InstantStructureMod.MODID, "selection_hud"),
                SelectionHudOverlay::render
        );
        event.registerAbove(
                VanillaGuiLayers.CROSSHAIR,
                Identifier.fromNamespaceAndPath(InstantStructureMod.MODID, "builder_placement_hud"),
